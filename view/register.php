            ...
            <div  style="width: 100%;padding: 5em 10em;background: #fff;border-radius: 10px;">
                ...
                <form  method="POST" action="">
                    ...
                    <span style="color: black;font-size: 13px;margin-bottom: 5em;line-height: 1.4;text-transform: uppercase;" class="txt1 p-b-11">
                        ...
                        <input style="height: 41px;border: 1px solid grey;box-shadow: 0px 0px 5px;width: 100%;" class="input100" type="text" name="name">
                        <span ></span>
                    </div>
                    ...
                    <div  data-validate="Username is required" style="margin-bottom: 36px;">
                        ...
                        <input style="height: 41px;border: 1px solid grey;box-shadow: 0px 0px 5px;width: 100%;" class="input100" type="text" name="username">
                        <span ></span>
                    </div>
                    ...
                    <div  data-validate="Password is required" style="margin-bottom: 36px;">
                        ...
                        <input style="height: 41px;border: 1px solid grey;box-shadow: 0px 0px 5px;width: 100%;" class="input100" type="password" name="password">
                        <span ></span>
                    </div>
                    <!-- <span style="color: black;font-size: 13px;margin-bottom: 5em;line-height: 1.4;text-transform: uppercase;" class="txt1 p-b-11">
						Re-Password
                    ...
                    <div  data-validate="Number phone is required" style="margin-bottom: 36px;">
                        ...
                        <input style="height: 41px;border: 1px solid grey;box-shadow: 0px 0px 5px;width: 100%;" class="input100" type="date" name="birtday">
                        <span ></span>
                    </div>
                    ...
                    <div  data-validate="Email is required" style="margin-bottom: 36px;">
                        ...
                        <input style="height: 41px;border: 1px solid grey;box-shadow: 0px 0px 5px;width: 100%;" class="input100" type="email" name="email">
                        <span ></span>
                    </div>
                    ...
                    <div  data-validate="Address is required" >
                        ...
                        <input style="height: 41px;border: 1px solid grey;box-shadow: 0px 0px 5px;width: 100%;" class="input100" type="number" name="phone">
                        <span ></span>
                    </div>   
                    ...
                    <div class="wrap-input100 validate-input m-b-12" data-validate="Address is required" >
                        ...
                        <input style="height: 41px;border: 1px solid grey;box-shadow: 0px 0px 5px;width: 100%;" class="input100" type="text" name="address">
